...
const BlogLoading = () => {
  return (
    <Container>
      <div className="flex gap-6 mt-20 mb-20 animate-pulse">
        <div className="w-full lg:w-2/3">
          ...
          <div className="flex flex-col gap-3">
            <p className="w-1/2 h-6 bg-gray-100 rounded"></p>
            <p className="w-8/12 h-3 bg-gray-100 rounded"></p>
            <p className="w-7/2 h-3 bg-gray-100 rounded"></p>
            <p className="w-6/12 h-2 bg-gray-100 rounded"></p>
            <p className="w-full h-10 bg-gray-100 rounded"></p>
            <p className="w-1/3 h-2 bg-gray-100 rounded"></p>
            <p className="w-1/3 h-2 bg-gray-100 rounded"></p>
            <p className="w-8/12 h-2 bg-gray-100 rounded"></p>
            <p className="w-7/12 h-3 bg-gray-100 rounded"></p>
            <p className="w-1/2 h-4 bg-gray-100 rounded"></p>
            <p className="w-8/12 h-3 bg-gray-100 rounded"></p>
            <p className="w-7/2 h-3 bg-gray-100 rounded"></p>
            <p className="w-6/12 h-2 bg-gray-100 rounded"></p>
            <p className="w-full h-10 bg-gray-100 rounded"></p>
